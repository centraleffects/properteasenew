...
<div id="btl">
	...
	<div class="btl-panel">
		...
		<?php else : ?>
			...
			?>
			<span id="btl-panel-login-y" class="<?php echo $effect;?>btn-login" onclick="jQuery('#login-popup').modal('show');setTimeout(function(){jQuery('.simplemodal-container .modalCloseImg:not(\'.second\')').remove();},900);$('#btl-content-login-y').show();"><?php echo JText::_('JLOGIN');?></span>
			<?php }?>
			<!-- Registration button -->
			<?php
