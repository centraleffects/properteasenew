...
<?php else: ?>
	...
	?>
		...
		<?php if ($this->ticket['dept'] && !FSS_Settings::get('user_hide_department')): ?>
			...
			<td colspan="2"><?php echo FSS_Translate_Helper::TrF('title', $this->ticket['dept'], $this->ticket['dtr']); ?></td>
		<?php endif; ?>

		<?php if ($this->ticket['cat'] && !FSS_Settings::get('support_hide_category') && !FSS_Settings::get('user_hide_category')): ?>
			<?php $mc->Item(); ?>
			<th><?php echo JText::_("CATEGORY"); ?></th>
			<td colspan="2"><?php echo FSS_Translate_Helper::TrF('title', $this->ticket['cat'], $this->ticket['ctr']); ?></td>
		<?php endif; ?>
