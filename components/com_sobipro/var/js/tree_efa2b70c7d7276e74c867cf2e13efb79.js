...
var menuTree_stmWait = 'http://test.local/properteasenew/media/sobipro/adm/spinner.gif';

menuTree_stmImgs[ 'root' ] = 'http://test.local/properteasenew/media/sobipro/tree/base.gif';
menuTree_stmImgs[ 'join' ] = 'http://test.local/properteasenew/media/sobipro/tree/join.gif';
menuTree_stmImgs[ 'joinBottom' ] = 'http://test.local/properteasenew/media/sobipro/tree/joinbottom.gif';
menuTree_stmImgs[ 'plus' ] = 'http://test.local/properteasenew/media/sobipro/tree/plus.gif';
menuTree_stmImgs[ 'plusBottom' ] = 'http://test.local/properteasenew/media/sobipro/tree/plusbottom.gif';
menuTree_stmImgs[ 'minus' ] = 'http://test.local/properteasenew/media/sobipro/tree/minus.gif';
menuTree_stmImgs[ 'minusBottom' ] = 'http://test.local/properteasenew/media/sobipro/tree/minusbottom.gif';
menuTree_stmImgs[ 'folder' ] = 'http://test.local/properteasenew/media/sobipro/tree/folder.gif';
menuTree_stmImgs[ 'disabled' ] = 'http://test.local/properteasenew/media/sobipro/tree/disabled.gif';
menuTree_stmImgs[ 'folderOpen' ] = 'http://test.local/properteasenew/media/sobipro/tree/folderopen.gif';
menuTree_stmImgs[ 'line' ] = 'http://test.local/properteasenew/media/sobipro/tree/line.gif';
menuTree_stmImgs[ 'empty' ] = 'http://test.local/properteasenew/media/sobipro/tree/empty.gif';;
